 ...
 * football icon on top and a small trending-up accent. Icon geometry is
 ...
 * after the first custom illustration didn't land. The accent is a bare
 * arrow with no enclosing circle: a circular badge here duplicated
 * Ticker's own logo mark shape, reading as a stray second app icon.
 * Static/shared across every preview (real per-article AI image generation
 * was explicitly deferred as a separate cost/architecture decision).
 */
  ...
  return (
    <View style={{ width: size, height: size, borderRadius: radius, overflow: "hidden" }}>
      <Svg width={size} height={size} viewBox="0 0 100 100">
        ...
        <G transform="translate(69,10)" stroke="#00170c" strokeWidth={2.2} fill="none" strokeLinecap="round" strokeLinejoin="round">
